...
CREATE TABLE `AIMER` (
  ...
  `AIMERDATE` datetime DEFAULT NULL,
...
CREATE TABLE `MENTION` (
  `IDUSER` int(11) NOT NULL,
  `IDTWEET` int(11) NOT NULL,
  `MENTDATE` datetime DEFAULT NULL,
...
CREATE TABLE `SUIVRE` (
  ...
  `SUIV_DATE` datetime NOT NULL,
  `DATESEEN` datetime DEFAULT NULL,
  `FLOOKORNOT` datetime DEFAULT NULL,
  PRIMARY KEY (`IDUSER_SUIVRE`),
  KEY `fk_user2` (`IDUSER_SUIVI`),
  CONSTRAINT `fk_user2` FOREIGN KEY (`IDUSER_SUIVI`) REFERENCES `USER` (`IDUSER`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TWEET` (
  ...
  `IDUSER` int(11) NOT NULL,
  `IDTWEET_REDONDRE` int(11) NOT NULL,
  `TWDATE` datetime DEFAULT NULL,
  `CONTIENT` char(32) DEFAULT NULL,
  PRIMARY KEY (`IDTWEET`),
  KEY `FK_TWEET_USER` (`IDUSER`),
  KEY `FK_TWEET_TWEET` (`IDTWEET_REDONDRE`),
  CONSTRAINT `TWEET_ibfk_1` FOREIGN KEY (`IDUSER`) REFERENCES `USER` (`IDUSER`),
  CONSTRAINT `TWEET_ibfk_2` FOREIGN KEY (`IDTWEET_REDONDRE`) REFERENCES `TWEET` (`IDTWEET`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-01-21  4:24:41
